...
#DEFINE CBREAK CHR(13)+' - Or -'+CHR(13)
CLOSE Tables
PUBLIC lcontinue, cplotvar(10,2), oPlotx(10), nplot, oPlot3(10), ccfndx
_Screen.Visible = .T.
_Screen.Caption = 'SoftmicaCalc'
*_Screen.WindowState = 1
_Screen.icon = 'D:\BIDCENTRAL2014\GEN.ICO'
SET DECIMALS TO 18
_TOOLTIPTIMEOUT = 0
SET PROCEDURE TO clock5 addi
nplot = 0

*DO CheckMemIntegrity
...
*!*	IF ! lregister OR ndaystorenew < 45
...
PROCEDURE ClassDef
	DEFINE CLASS CodeandPurpose AS Custom
		.Code = ''
		.Purpose = ''
	ENDDEFINE 
ENDPROC 
...
LOCAL iix
	IF (ntotalMemRequired) > RECCOUNT('Calc') 
		IF lextendmem
			FOR iix =  RECCOUNT('Calc') TO nTotalMemRequired 
				oCalc.CreateEmptyValueInMem
			ENDFOR 
		ELSE
			RETURN .F.
		ENDIF 
...
FUNCTION GetText
PARAMETERS ccaption, cprompt, ncx, lmandatory, cdefault
LOCAL cretval
	DO FORM entertext WITH ccaption, cprompt, ncx, lmandatory, cdefault TO cretval
...
PARAMETERS cReportx,lhtml,lrange, lpreview, lrep90,cTitle, cSubTitle
PUBLIC cTitlex, cSubTitlex
LOCAL cFilename, cpreview
*!*	PUBLIC csaveddbf
*!*	csavedbf = ALIAS()
cTitlex = cTitle
cSubTitlex = cSubTitle
